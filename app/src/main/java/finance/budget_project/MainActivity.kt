            ...
            NavigationBar {
                ...
                val visibleScreens = if (AuthViewModel.isLoggedIn) {
                    listOf(MainActivity.CurrentScreen.Home, MainActivity.CurrentScreen.Expense
                        ,MainActivity.CurrentScreen.Agenda
                    ,MainActivity.CurrentScreen.Setting)
                } else {
                        ...
                        icon = {
                            Icon(
                                imageVector = when (screen) {
                                    ...
                                    MainActivity.CurrentScreen.Agenda -> Icons.Default.CalendarMonth
                                    MainActivity.CurrentScreen.Setting -> Icons.Default.Settings
                                },
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(MainActivity.CurrentScreen.Agenda.name) {
            AgendaScreen()
        }
        composable(MainActivity.CurrentScreen.Setting.name) {
            val toScreen = MainActivity.CurrentScreen.Home.name

            SettingScreen(navController = navController, toScreen = toScreen)
        }
    }
}
